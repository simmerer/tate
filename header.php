...
<head>
    ...
    <script type="text/javascript" src="<?php echo bloginfo('stylesheet_url'); ?>/../js/tate.js"></script>
    <script type="text/javascript" src="<?php echo bloginfo('stylesheet_url'); ?>/../html5gallery/html5gallery.js"></script>
...
<body <?php body_class( $agilitySettings->op( 'background-preset' ).' '.$agilitySettings->op( 'highlight-color' ).' '. ( $agilitySettings->op( 'box-layout' ) ? 'box-layout' : '' ) ); ?>>
    ...
    <!-- .pages .wrap -->
    <div data-role="page" class="pages wrap hfeed site">
        
        <?php do_action( 'before' ); ?>
        
        <!-- Header -->
        <header data-role="header" class="container site-header site-header-full-width" role="banner">
            
            <div class="header-inner sixteen columns over">
                
                <hgroup class="masthead">
                    <h1 class="site-title"><a href="<?php echo home_url( '/' ); ?>" title="<?php echo esc_attr( get_bloginfo( 'name', 'display' ) ); ?>" rel="home"><?php
            ...
            <?php if(is_front_page()) { ?>
                ...
                <div id="momenu">
                    <?php dynamic_sidebar( 'superheader' ); ?>
                </div>
